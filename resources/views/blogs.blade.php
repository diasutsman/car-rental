        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 pull-right col-xs-12">
                    ...
                    <ul class="list">
                        <li><a href="{{ route('blog-details') }}">Lorem ipsum dolor sit amet, consectetur adipisicing.</a>
                        </li>
                        <li><a href="{{ route('blog-details') }}">Et animi voluptatem, assumenda enim, consectetur
                                quaerat!</a>
                        </li>
                        <li><a href="{{ route('blog-details') }}">Ducimus magni eveniet sit doloremque molestiae alias
                                mollitia
                                vitae.</a></li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="courses-thumb courses-thumb-secondary">
                                ...
                                <div class="courses-detail">
                                    <h3><a href="{{ route('blog-details') }}">A voluptas ratione, error provident
                                            distinctio,
                        ...
                        <div class="col-sm-6">
                            <div class="courses-thumb courses-thumb-secondary">
                                ...
                                <div class="courses-detail">
                                    <h3><a href="{{ route('blog-details') }}">Tempora molestiae, iste, consequatur unde
                                            sint
                                            praesentium!</a></h3>
                                </div>
